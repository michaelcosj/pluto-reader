...
import "github.com/michaelcosj/pluto-reader/views/icons"
...
func Sidebar() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"sidebar-container\"><div class=\"z-50 sidebar absolute top-0 left-0 h-screen w-16 bg-accent text-background py-2 px-4 transition-all duration-300 delay-75 ease-in\"><div class=\"top\"><div class=\"logo h-12 w-full flex gap-1.5 items-center opacity-0\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = icons.Atom().Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = icons.BellDot().Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = icons.RSS().Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = icons.Library().Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<span class=\"inline-block\"><p>Collections</p></span> <span class=\"tooltip opacity-0 group-hover:opacity-100 absolute left-20 top-1 bg-text text-background translate-1/2 shadow-md rounded-xl py-0.5 px-3 z-50\">Collections</span></div></li></ul></div><div class=\"main-content relative transition-all delay-100 duration-500 \">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
